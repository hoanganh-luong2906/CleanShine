...
const AddServiceTypeForm = () => {
  ...
  const handleAddServiceType = async () => {
    ...
    const apiUrl = process.env.REACT_APP_API_URL;
    const res = await fetch(apiUrl + "admin/create-service-detail", {
      method: "POST",
      headers: {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">Thêm loại dịch vụ</DialogTitle>
        <DialogContent>
        ...
        <DialogActions>
          ...
          <Button onClick={handleAddServiceType} autoFocus>
            Đồng ý
          </Button>
        </DialogActions>
      </Dialog>
